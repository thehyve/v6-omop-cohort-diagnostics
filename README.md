...
- [Adapted implementation](#adapted-implementation)
...
- [Privacy Guards](#privacy-guards)
  - [Minimum cell count](#minimum-cell-count)
- [Build](#build)
- [Node configuration](#node-configuration)
  - [1. Attach OMOP database to the internal vantage6 network](#1-attach-omop-database-to-the-internal-vantage6-network)
  - [2. Add OMOP database to the node configuration file](#2-add-omop-database-to-the-node-configuration-file)
